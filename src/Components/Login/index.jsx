  ...
  return (
    <div>
      ...
      <div className="login-container">
        ...
        <form onSubmit={onSubmit} className="form login">
          <div className="form__field form__field--email">
            <label className="label label--icon" htmlFor="login__username">
              <svg className="icon">
          ...
          <div className="form__field form__field--password">
            <label className="label label--icon" htmlFor="login__password">
              <svg className="icon">
          ...
          <div className="login-actions-container">
            <div className="form__field form__field--remember-me">
              <label className="label label--remember-me" htmlFor="login__remember-me">
                <input
            ...
            <div className="form__field form__field--submit">
              <input type="submit" value={`${loading ? '...' : 'sign in'}`} />
            </div>
          </div>
        </form>

        <svg width="0" height="0" xmlns="http://www.w3.org/2000/svg" className="icons">
      ...
      <script
        ...
        integrity="sha256-S6G5lg9rzC1JCAkx3dQFqP2lefkFxwlNVn0rWCOueXA="
        crossOrigin="anonymous"
      ></script>
      <script src="./loginCartoonAnimation.js"></script>
    </div>
  );
}
